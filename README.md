...
Note: with cookie authentication, `ls`, `down`, `up`, `sync`, and `del` use 115 web endpoints. Cookie uploads first try instant upload by SHA1 and fall back to OSS upload with 115 web upload signing.
